    ...
    targets.forEach(item => {
      ...
      counters.forEach(el => {
        ...
        buttonDown.addEventListener('click', () => {
          ...
          } else if (count.innerHTML != 1 && (el.getAttribute('data-value-change') == ".js-count-adult" || el.getAttribute('data-value-change') == ".js-count-room")) {
            count.innerHTML = parseInt(count.innerHTML) - 1
            if (el.getAttribute('data-value-change') == ".js-count-adult") {
              if (count.innerHTML > 0) {
                item.querySelector(el.getAttribute('data-value-change')).innerHTML = parseInt(count.innerHTML)
              }
            } else if (el.getAttribute('data-value-change') == ".js-count-room") {
              if (count.innerHTML > 0) {
                item.querySelector(el.getAttribute('data-value-change')).innerHTML = parseInt(count.innerHTML)
              }
            }
