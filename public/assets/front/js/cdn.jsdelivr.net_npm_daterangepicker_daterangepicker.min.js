        ...
        (a.prototype = {
            ...
            setEndDate: function (e) {
                "string" == typeof e && (this.endDate = t(e, this.locale.format)),
                   ...
                   if((this.endDate && (this.startDate.isBefore(this.endDate) || this.startDate.isSame(this.endDate)))){                    
                    $("input[name=daterange]").val(this.startDate.format(this.locale.format) + this.locale.separator + this.endDate.format(this.locale.format));
                    $("#hidden_from").val(this.startDate.format('YYYY-MM-DD')); //2024-03-13
                    $("#hidden_to").val(this.endDate.format('YYYY-MM-DD'));  // 2024-03-13  
                    $(".show-calendar").css("display", "none");  // 2024-03-13
                    var start = new Date(this.startDate.format('YYYY-MM-DD')),
                        end   = new Date(this.endDate.format('YYYY-MM-DD')),
                        diff  = new Date(end - start),
                        days  = diff/1000/60/60/24;
                    $(".checkin-out .nights").html('( '+ days +' Nights )');  // 2024-03-13                       

                    createCookie('search_from', JSON.stringify(this.startDate.format('YYYY-MM-DD')), 1);
                    createCookie('search_to', JSON.stringify(this.endDate.format('YYYY-MM-DD')), 1);
                    // createCookie('search_from', JSON.stringify(this.startDate.format('DD/MM/YYYY')), 1);
                    // createCookie('search_to', JSON.stringify(this.endDate.format('DD/MM/YYYY')), 1);
                    //  createCookie('dateHomeFrom', JSON.stringify(this.startDate.format('DD/MM/YYYY')), 1);
                    //  createCookie('dateHomeTo', JSON.stringify(this.endDate.format('DD/MM/YYYY')), 1);
                     createCookie('dateHomeDay', JSON.stringify('( '+ days +' Nights )'), 1);
            ...
            updateFormInputs: function () {
                ...
                if((this.endDate && (this.startDate.isBefore(this.endDate) || this.startDate.isSame(this.endDate)))){                    
                   ...
                   // $("input[name=hidden_from]").val();
                    //$("input[name=hidden_to]").val();
