                        ...
                        v = function (b, c, d) {
                            b.each(function (b) {
                                ...
                                e.data("item-name", c + "[" + parseInt(b + parseInt(1)) + "]"),
                                    l(e.find("[dropzonename]"), d).each(function () {
                                        var f = a(this),
                                            g = f.attr("dropzonename").match(/\[[^\]]+\]/g),
                                            i = g ? h(g).replace(/\[|\]/g, "") : f.attr("dropzonename");

                                        f.attr('id', 'roomImageDropzone_' + parseInt(b));

                                        // f.attr("dropzonename", j),
                                        //     u(d, e, function (d) {
                                        //         var e = a(this);
                                        //         v(l(e.find("[data-repeater-item]"), d.repeaters || []), c + "[" + b + "][" + e.find("[data-repeater-list]").first().data("repeater-list") + "]", d.repeaters);
                                        //     });
                                ...
                                e.data("item-name", c + "[" + parseInt(b + parseInt(1)) + "]"),
                                    l(e.find("[dropzonegallery]"), d).each(function () {
                                        var f = a(this),
                                            g = f.attr("dropzonegallery").match(/\[[^\]]+\]/g),
                                            i = g ? h(g).replace(/\[|\]/g, "") : f.attr("dropzonegallery");

                                        f.attr('id', 'roomGalleryDropzone_' + parseInt(b));

                                    });
                                e.data("item-name", c + "[" + parseInt(b + parseInt(1)) + "]"),
                                    l(e.find("[room-title]"), d).each(function () {
                                        var f = a(this),
                                            g = f.attr("room-title").match(/\[[^\]]+\]/g),
                                            i = g ? h(g).replace(/\[|\]/g, "") : f.text();
                                        f.text('Room ' + parseInt(b + parseInt(1)));
                                    });
                                e.data("item-name", c + "[" + parseInt(b + parseInt(1)) + "]"),
                                    l(e.find("[child-title]"), d).each(function () {
                                        var f = a(this),
                                            g = f.attr("child-title").match(/\[[^\]]+\]/g),
                                            i = g ? h(g).replace(/\[|\]/g, "") : f.text();
                                        f.text('Children Details ' + parseInt(b + parseInt(1)));
                                    });
                                e.data("item-name", c + "[" + parseInt(b + parseInt(1)) + "]"),
                                    l(e.find("[package-title]"), d).each(function () {
                                        var f = a(this),
                                            g = f.attr("package-title").match(/\[[^\]]+\]/g),
                                            i = g ? h(g).replace(/\[|\]/g, "") : f.text();
                                        f.text('Itinerary Item ' + parseInt(b + parseInt(1)));
                                    });
                                e.data("item-name", c + "[" + parseInt(b + parseInt(1)) + "]"),
                                    l(e.find("[data-desc"), d).each(function () {
                                        var f = a(this),
                                            g = f.attr("data-desc").match(/\[[^\]]+\]/g),
                                            i = g ? h(g).replace(/\[|\]/g, "") : f.text();
                                        f.attr('id', 'my-description-' + parseInt(b));
                                        console.log();
                                    });
                                l(e.find("[name]"), d).each(function () {
                                    var f = a(this),
                                   ...
                                   // var radioName = $('input[name=cancelation_policy]:checked', '#FrmOfflineRoomPrice').val();

                                    // if(radioName != "refundeble" && ('start_date' == i || 'end_date' == i )){
                                    //     console.log('j');
                                    // } else 
                                    
                                    if ( 'start_date' == i || 'end_date' == i || 'meal_plan' == i || 'room_freebies' == i || 'id' == i || 'room_id' == i || 'price_id' == i || 'edit_id' == i || 'edit_package_id' == i || 'description' == i) {
