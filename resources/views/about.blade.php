        ...
        <div data-anim-wrap class="container">
            ...
            <div class="row y-gap-40 justify-between pt-50">
                ...
                <div data-anim-child="slide-up delay-2" class="col-lg-3 col-sm-6">
                    ...
                    <div class="featureIcon -type-1 ">
                        <div class="d-flex justify-center">
                            <img src="#" data-src="{{ asset('assets/front') }}/img/featureIcons/1/1.svg" alt="image" class="js-lazy">
                        </div>
                ...
                <div data-anim-child="slide-up delay-3" class="col-lg-3 col-sm-6">
                    ...
                    <div class="featureIcon -type-1 ">
                        <div class="d-flex justify-center">
                            <img src="#" data-src="{{ asset('assets/front') }}/img/featureIcons/1/2.svg" alt="image" class="js-lazy">
                        </div>
                ...
                <div data-anim-child="slide-up delay-4" class="col-lg-3 col-sm-6">
                    ...
                    <div class="featureIcon -type-1 ">
                        <div class="d-flex justify-center">
                            <img src="#" data-src="{{ asset('assets/front') }}/img/featureIcons/1/3.svg" alt="image" class="js-lazy">
                        </div>
            ...
            <div class="row y-gap-30 justify-between items-center">
                <div class="col-lg-5">
                    ...
                    <p class="text-dark-1 mt-60 lg:mt-40 md:mt-20">
                        ...
                        like the British Museum as well as see how far it has come by simply riding the Tube and passing by
                        celebrated landmarks like Buckingham Palace, Westminster Abbey, and marvels like Big Ben, the London
                        Eye, and the Tower Bridge.
                    </p>
                </div>
            ...
            <div class="overflow-hidden pt-40 js-section-slider" data-gap="30"
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="">
                            <img src="{{ asset('assets/front') }}/img/team/1.png" alt="image" class="rounded-4 col-12">
                    ...
                    <div class="swiper-slide">
                        <div class="">
                            <img src="{{ asset('assets/front') }}/img/team/2.png" alt="image" class="rounded-4 col-12">
                    ...
                    <div class="swiper-slide">
                        <div class="">
                            <img src="{{ asset('assets/front') }}/img/team/3.png" alt="image" class="rounded-4 col-12">
                    ...
                    <div class="swiper-slide">
                        <div class="">
                            <img src="{{ asset('assets/front') }}/img/team/4.png" alt="image" class="rounded-4 col-12">
                    ...
                    <div class="swiper-slide">
                        <div class="">
                            <img src="{{ asset('assets/front') }}/img/team/5.png" alt="image" class="rounded-4 col-12">
                    ...
                    <div class="swiper-slide">
                        <div class="">
                            <img src="{{ asset('assets/front') }}/img/team/6.png" alt="image" class="rounded-4 col-12">
                    ...
                    <div class="swiper-slide">
                        <div class="">
                            <img src="{{ asset('assets/front') }}/img/team/7.png" alt="image" class="rounded-4 col-12">
                        ...
                        <div class="testimonials -type-1 bg-white rounded-4 pt-40 pb-30 px-40">
                            ...
                            <div class="pt-20 mt-28 border-top-light">
                                <div class="row x-gap-20 y-gap-20 items-center">
                                    <div class="col-auto">
                                        <img class="size-60" src="{{ asset('assets/front') }}/img/avatars/1.png" alt="image">
                                    </div>
