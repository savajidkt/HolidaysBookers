...
@section('page_title', __('vendor/vendor.title'))
@section('content')
    <!-- users list start -->
    <section class="app-user-list">
        ...
        <div class="card">
            <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                ...
                <div class="col-md-6">
                    <h4 class="card-title">{{ __('vendor/vendor.title') }}</h4>
                </div>
                <div class="col-md-6 text-right">
                    ...
                    <a href="{{ route('vendors.create') }}"><button type="reset"
                            class="btn btn-primary mr-1 waves-effect waves-float waves-light">{{ __('vendor/vendor.add_new') }}</button></a>
                </div>
            </div>
