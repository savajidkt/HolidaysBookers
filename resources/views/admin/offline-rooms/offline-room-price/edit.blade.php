...
@section('content')
    <div class="card-header border-bottom d-flex justify-content-between align-items-center my-2">
        <div class="col-md-6">
            <a class="btn btn-outline-secondary waves-effect" href="{{ route('offlinerooms.edit', $model->id) }}">Back</a>
        </div>
        <div class="col-md-6 text-right">
            <a href="{{ route('add-room-price', $model->id) }}"
                class="btn btn-primary btn-sm waves-effect waves-float waves-light" data-toggle="tooltip"
                data-original-title="Add Room Price" data-animation="false"><i class="fa fa-plus" aria-hidden="true"></i> Add
                Room Price</a>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="FrmOfflineRoomPrice" class="" novalidate method="post"
                            enctype="multipart/form-data" action="{{ route('edit-room-price', $pricemodel) }}">
                            @csrf
                ...
                <div class="modal fade text-left" id="complimentaryPlan" tabindex="-1" aria-labelledby="myModalLabel120"
                                        ...
                                        <form action="" method="post" id="complimentaryPlanFrm"
                                            ...
                                            <div class="row g-3">
                                                <div class="col-sm-6 fv-plugins-icon-container">
                                                    <label class="form-label" for="plFirstName">Supplementary Name *</label>
                                                    <select class="select2-room-meal-plan-complimentary form-control select2"
                                                        name="complimentary_name"></select>
                                                    ...
                                                    <div class="demo-inline-spacing">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="radio" class="custom-control-input"
                                                                id="hotel_c" value="1" name="apply_for">
                                                            <label class="custom-control-label"
                                                                for="hotel_c">Hotel</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="radio" class="custom-control-input"
                                                                id="room_c" value="0" name="apply_for" checked>
                                                            <label class="custom-control-label"
                                                                for="room_c">Room</label>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="modal fade text-left" id="promotionalPlan" tabindex="-1" aria-labelledby="myModalLabel120"
                    aria-hidden="true" data-backdrop="static">
                    <div class="modal-dialog modal-lg modal-simple" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                        ...
                                        <form action="" method="post" id="promotionalPlanFrm"
                                            ...
                                            <div class="row g-3">
                                                <div class="col-sm-4 fv-plugins-icon-container">
                                                    ...
                                                    <input type="number" name="single_adult" class="form-control"
                                                        placeholder="Single Adult">
                                                </div>
                                                <div class="col-sm-4 fv-plugins-icon-container">
                                                    <label class="form-label" for="plFirstName">Per Room *</label>
                                                    <input type="number" name="per_room" class="form-control"
                                                        placeholder="Per Room">
                                                </div>
                                                <div class="col-sm-4 fv-plugins-icon-container">
                                                    <label class="form-label" for="plFirstName">Extra Adult *</label>
                                                    <input type="number" name="extra_adult" class="form-control"
                                                        placeholder="Extra Adult">
                                                </div>
                                                <div class="col-sm-4 fv-plugins-icon-container">
                                                    <label class="form-label" for="plFirstName">Child with Bed *</label>
                                                    <input type="number" name="child_with_bed" class="form-control"
                                                        placeholder="Child with Bed">
                                                </div>
                                                <div class="col-sm-4 fv-plugins-icon-container">
                                                    <label class="form-label" for="plFirstName">Child no Bed (0-4
                                                        Years) *</label>
                                                    <input type="number" name="child_with_no_bed_0_4"
                                                        class="form-control" placeholder="Child no Bed (0-4 Years)">
                                                </div>
                                                <div class="col-sm-4 fv-plugins-icon-container">
                                                    <label class="form-label" for="plFirstName">Child no Bed (5-12
                                                        Years) *</label>
                                                    <input type="number" name="child_with_no_bed_5_12"
                                                        class="form-control" placeholder="Child no Bed (5-12 Years)">
                                                </div>
                                                <div class="col-sm-4 fv-plugins-icon-container">
                                                    <label class="form-label" for="plFirstName">Child no Bed (13-18
                                                        Years) *</label>
                                                    <input type="number" name="child_with_no_bed_13_18"
                                                        class="form-control" placeholder="Child no Bed (13-18 Years)">
                                                </div>

                                                <div class="col-sm-4">
                                                    <label class="form-label" for="plUserName">Date Validity *</label>
                                                    <input type="text" id="date_validity" name="date_validity"
                                                ...
                                                <div class="col-sm-6 fv-plugins-icon-container mt-2">
                                                    ...
                                                    <div class="demo-inline-spacing">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="radio" class="custom-control-input"
                                                                id="hotel_p" value="1" name="apply_for_p">
                                                            <label class="custom-control-label"
                                                                for="hotel_p">Hotel</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="radio" class="custom-control-input"
                                                                id="room_p" value="0" name="apply_for_p" checked>
                                                            <label class="custom-control-label"
                                                                for="room_p">Room</label>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="modal fade text-left" id="stopSalePlan" tabindex="-1" aria-labelledby="myModalLabel120"
                    aria-hidden="true" data-backdrop="static">
                    <div class="modal-dialog modal-lg modal-simple" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    <label class="form-label" for="plUserName">Stop Sale
                                                        Date *</label>
                                                    <input type="text" id="stop_sale_date" name="stop_sale_date"
