            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    <div class="card-header bg-primary bg-lighten-2 colors-container">
                        <h4 class="card-title text-white">Edit Currency</h4>
                    </div>
                    <div class="card-body">
                        <form id="FrmCurrency" class="needs-validation1" novalidate method="post"
                            enctype="multipart/form-data" action="{{ route('currencies.update', $model) }}">
                            @csrf
                            @method('PUT')
