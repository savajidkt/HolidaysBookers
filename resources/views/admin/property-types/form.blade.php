<div class="row">
    <div class="col-12">
        <div class="form-group">
            ...
            <input type="text" id="basic-addon-property_name" name="property_name" class="form-control"
                placeholder="{{ __('propertytype/propertytype.form_property_name') }}" onkeydown="return /[a-z]/i.test(event.key)"
    ...
    <div class="col-12">
        <div class="form-group">
            ...
            <select name="status" class="select2 form-control" id="status" data-error="{{ __('propertytype/message.status_required') }}">
