...
@section('page_title', 'New Hotel Facility')
@section('content')
            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">New Hotel Facility</h4>
                    </div>
                    <div class="card-body">
                        <form id="FrmHotelFacility" class="needs-validation1" method="post" enctype="multipart/form-data"
                            action="{{ route('hotelfacility.store') }}">
