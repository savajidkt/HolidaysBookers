...
@section('page_title', __('agent-markup/agent-markup.form_add_page_title'))
@section('content')
            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('agent-markup/agent-markup.add_new') }}</h4>
                    </div>
                    <div class="card-body">
                        <form id="FrmAgentMarkup" class="needs-validation1" method="post" enctype="multipart/form-data"
                            action="{{ route('agentmarkups.store') }}">
