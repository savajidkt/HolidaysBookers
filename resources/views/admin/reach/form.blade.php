<div class="row">
    ...
    @php
        ...
        if (isset($model->textbox_label) || $model->show_other_textbox == 1) {
            $hide = '';
        } else {
            $hide = 'hide';
        }
    ...
    <div class="col-12 textbox_lable_div {{ $hide }}">
        <div class="form-group">
            ...
            <input type="text" id="basic-addon-textbox_lable" name="textbox_lable" onkeydown="return /[a-zA-Z ]/.test(event.key)" class="form-control"
