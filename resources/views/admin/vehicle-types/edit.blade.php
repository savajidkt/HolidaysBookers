            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('vehicletype/vehicletype.form_edit_title') }}</h4>
                    </div>
                    <div class="card-body">
                        <form id="FrmVehicleType" class="needs-validation1" novalidate method="post"
                            enctype="multipart/form-data" action="{{ route('vehicletypes.update', $model) }}">
                            @csrf
                            @method('PUT')
