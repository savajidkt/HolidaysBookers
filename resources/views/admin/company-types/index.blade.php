...
@section('page_title', __('company-type/company-type.list_page_title'))
@section('content')
    <!-- users list start -->
    <section class="app-user-list">
        ...
        <div class="card">
            <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                <h4 class="card-title">{{ __('company-type/company-type.list_page_title') }}</h4>
                <a href="{{ route('companytypes.create') }}"><button type="reset"
                        class="btn btn-primary mr-1 waves-effect waves-float waves-light">{{ __('company-type/company-type.add_new') }}</button></a>
