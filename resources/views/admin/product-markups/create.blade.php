...
@section('page_title', __('product-markup/product-markup.form_add_page_title'))
@section('content')
            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('product-markup/product-markup.add_new') }}</h4>
                    </div>
                    <div class="card-body">
                        <form id="FrmProductMarkup" class="needs-validation1" method="post" enctype="multipart/form-data"
                            action="{{ route('productmarkups.store') }}">
