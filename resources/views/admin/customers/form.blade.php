    ...
    <div class="col-4">
        <div class="form-group">
            ...
            <input type="text" id="basic-addon-first_name" name="first_name" class="form-control"
                placeholder="First Name" onkeydown="return /[a-z]/i.test(event.key)" value="{{ isset($model->first_name) ? $model->first_name : old('first_name') }}"
    ...
    <div class="col-4">
        <div class="form-group">
            ...
            <input type="text" id="basic-addon-last_name" name="last_name" class="form-control"
                placeholder="Last Name" onkeydown="return /[a-z]/i.test(event.key)" value="{{ isset($model->last_name) ? $model->last_name : old('last_name') }}"
    ...
    <div class="col-4">
        <div class="form-group">
            ...
            <input type="text" id="fp-default" name="dob" class="form-control flatpickr-basic flatpickr-input"
                ...
                value="{{(isset($customer->dob))? $customer->dob:''}}" data-error="Date of birth is required" />
            <div class="valid-feedback">{{ __('core.looks_good') }}</div>
            @error('dob')
                <div class="invalid-feedback" style="display: block;">{{ $message }}</div>
            @enderror
        ...
        <div class="form-group">
            ...
            <select class="select2 form-control form-control-lg" id="country" name="country"
                ...
                @foreach ($countries as $country)
                    <option value="{{ $country->id }}" {{ (isset($customer->country) && $customer->country == $country->id) ? 'selected' : ''}}>
                        {{ $country->name }}</option>
                @endforeach
            </select>
    ...
    <div class="col-4">
        <div class="form-group myState">
            ...
            <select class="select2 form-control form-control-lg" id="state" name="state"
                ...
                @php $states = getCountryStates(isset($customer->country) ? $customer->country : '');  @endphp
                @if ($states->count() > 0)
    ...
    <div class="col-4">
        <div class="form-group myCity">
            ...
            <select class="select2 form-control form-control-lg" id="city" name="city"
                ...
                @php $cities = getStateWiseCity(isset($customer->state) ? $customer->state : '');  @endphp
                @if ($cities->count() > 0)
    ...
    <div class="col-4">
        <div class="form-group">
            ...
            <input type="text" id="basic-addon-zipcode" name="zipcode" class="form-control"
                placeholder="Zipcode" oninput="this.value = this.value.replace(/[^0-9a-zA-Z]+/g, '').replace(/(\..*)\./g, '$1');" value="{{ isset($customer->zipcode) ? $customer->zipcode : old('zipcode') }}"
    ...
    <div class="col-4">
        <div class="form-group">
            ...
            <input type="text" id="basic-addon-telephone" name="telephone" class="form-control"
                placeholder="Telephone" value="{{ isset($customer->telephone) ? $customer->telephone : old('telephone') }}"
    ...
    <div class="col-4">
        <div class="form-group">
            ...
            <input type="text" id="basic-addon-mobile_number" name="mobile_number" class="form-control"
                ...
                value="{{ isset($customer->mobile_number) ? $customer->mobile_number : old('mobile_number') }}"
    ...
    <div class="col-4">
        <div class="form-group">
            ...
            <input type="text" id="basic-addon-email_address" name="email_address" class="form-control"
                ...
                value="{{ isset($model->email) ? $model->email : old('email_address') }}"
