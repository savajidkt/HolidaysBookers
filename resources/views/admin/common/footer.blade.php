<footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">&copy; {{date('Y')}} Holidays Bookers<span class="d-none d-sm-inline-block">, All Rights Reserved</span></span></p>
    </footer>
...
<div class="toast toast-autohide" role="alert" aria-live="assertive" aria-atomic="true" data-autohide="false">
    <div class="toast-header">
        ...
        <strong class="mr-auto">Holidays Bookers</strong>
