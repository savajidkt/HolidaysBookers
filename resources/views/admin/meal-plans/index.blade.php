        ...
        <div class="card">
            <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                ...
                <div class="col-md-6 text-right">
                    <a href="{{ route('mealplans.create') }}"><button type="reset"
    ...
    <script type="text/javascript">
        $(function() {
            table = $('.user-list-table').DataTable({
                ...
                e.preventDefault();
                var $this = $(this),
                    meal_plan_id = $this.data('meal_plan_id'),
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "{{ route('change-meal-plan-status') }}",
                            dataType: 'json',
                            data: {
