...
@section('page_title', 'New Meal Plan')
@section('content')
            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    <div class="card-header bg-primary bg-lighten-2 colors-container">
                        <h4 class="card-title text-white">New Meal Plan</h4>
                    </div>
                    <div class="card-body">
                        <form id="FrmMealPlans" class="needs-validation1" method="post" enctype="multipart/form-data"
                            action="{{ route('mealplans.store') }}">
                            @csrf
