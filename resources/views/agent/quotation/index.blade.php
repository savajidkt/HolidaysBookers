                    ...
                    <div class="">
                        <div class="row x-gap-20 y-gap-30">
                            <div class="col-md-12 bg-light-2">
                                <div class="row">
                                    <div class="col-md-3">
                                        <h3 class="text-18 lh-14 fw-500">Quote Name</h3>
                                        <div class="row x-gap-10 y-gap-10 items-center">
                                            <div class="col-auto">
                                                <a href="javascript:void(0);" class="text-blue-1 mt-5"
                                                    data-order-id="{{ $value->id }}"> Change</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <h3 class="text-18 lh-14 fw-500">Agent Name</h3>
                                        <div class="row x-gap-10 y-gap-10 items-center">
                                            <div class="col-auto">
                                                <a href="javascript:void(0);" class="text-blue-1 mt-5"
                                                    data-order-id="{{ $value->id }}"> Change</a>
                                    ...
                                    <div class="col-md-2">
                                        <h3 class="text-18 lh-14 fw-500">Telephone</h3>
                                        <div class="row x-gap-10 y-gap-10 items-center">
                                            <div class="col-auto">
                                                <a href="javascript:void(0);" class="text-blue-1 mt-5"
                                                    data-order-id="{{ $value->id }}"> Change</a>
                                    ...
                                    <div class="col-md-2">
                                        <h3 class="text-18 lh-14 fw-500">Email</h3>
                                        <div class="row x-gap-10 y-gap-10 items-center">
                                            <div class="col-auto">
                                                <a href="javascript:void(0);" class="text-blue-1 mt-5"
                                                    data-order-id="{{ $value->id }}"> Change</a>
                            ...
                            <div class="col-md-10">
                                @if (count($value->quote_hotel_rooms) > 0)
                                    ...
                                    @foreach ($value->quote_hotel_rooms as $roomkey => $roomvalue)
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h3 class="text-18 lh-14 fw-500">{{ $roomvalue->hotel_details->hotel_name }}
                                                </h3>
                                                <div class="row x-gap-10 y-gap-10 items-center">
                                                    <div class="col-auto">
                                            ...
                                            <div class="col-md-3">
                                                <h3 class="text-18 lh-14 fw-500">
                                                    {{ numberFormat($roomvalue->price, $value->booking_currency) }}</h3>
                                                <div class="row x-gap-10 y-gap-10 items-center">
                                                    <div class="col-auto">
            ...
            <div class="pt-24">
                ...
                <span class="fw-500 text-blue-1 QuoteDetails">
                    ...
                    <a href="{{ route('agent.order-view', $value->id) }}" class="text-blue-1 mt-5"
                        data-order-id="{{ $value->id }}">Share </a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="bravo-theme-gotrip-login-form y-gap-20" method="POST" action="{{ route('agent.order-edit-price','') }}"
                        id="EditPriceFrm" novalidate="novalidate">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-input extra_markup_price-error">
                                    <input data-c-p="" data-cy-price="" type="number" name="extra_markup_price" class="has-value emailInput extra_markup_price">
                            ...
                            <div class="col-4">
                                <div class="form-input">
                                    <input type="text" value="" class="has-value emailInput final_markup_price" disabled>
                                    <label class="lh-1 text-14 text-light-1">
