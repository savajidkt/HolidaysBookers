                ...
                <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls">
                    <div class="col-auto">
                        <a href="{{ route('customer.booking-history','all') }}"
                            class="tabs__button text-18 lg:text-16 text-light-1 fw-500 pb-5 lg:pb-0  is-tab-el-active ">
                            All Booking
                        </a>
                    </div>
                    <div class="col-auto">
                        <a href="{{ route('customer.booking-history','completed') }}"
                            class="tabs__button text-18 lg:text-16 text-light-1 fw-500 pb-5 lg:pb-0 ">
                            Completed
                        </a>
                    </div>
                    <div class="col-auto">
