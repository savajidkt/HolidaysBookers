...
class PropertyType extends Model
{
    ...
    public function getActionAttribute(): string
    {
        ...
        $editAction = '<a href="' . route('propertytypes.edit', $this->id) . '" class="edit" data-toggle="tooltip" data-original-title="Admin Edit" data-animation="false"><img src="' . asset("app-assets/images/icons/icons8-edit-64.png") . '" width="20"></a>';
